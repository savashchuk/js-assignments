...
function isString(value) {
    ...
    if(value != null){
      if( (typeof(value) == 'object') && (value.length > 0) && (typeof(value[0]) == 'string') ){
        return true;
      }
    }
    return false;
...
function getCardId(value) {
  let lastSym = value.substring(value.length - 1, value.length);
  let firstSym = value.substring(0, value.length - 1)
  switch(lastSym){
    case '♣':
      lastSym = 0;
      break;
  ...
  let result = 0 - - firstSym - - lastSym - 1;
  return result;
}
